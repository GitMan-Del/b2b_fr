...
export default function VerticalLines({
  ...
  if (variant === "Var2") {
    ...
    return (
      <div className="absolute inset-0 w-full pointer-events-none z-20">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <React.Fragment key={step.number}>
                {/* Badge (cerc) – neatins, lipit de linie */}
                <div
                ...
                <div
                  ...
                  style={{
                    left: isEven ? "55%" : "20%",
                    // left: steps[index]?.number === "1" || steps[index]?.number === "3" ? "55%" : "20%",
                    top: `${topPosition - 1}%`, // puțin mai sus ca să alinieze frumos cu badge-ul
                  }}
                >
                  <p
                  ...
                  >
                    <span className="text-white">Step {step.number}.</span> {step.title}
                  </p>
