...
export default function Section2() {
  ...
  return (
    <section className="min-h-screen h-[120vh] w-full flex items-start justify-center z-10 flex-col px-20 relative">
